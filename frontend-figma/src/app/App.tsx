...
const ALL_MARKERS = [
  // Caribbean coast
  { name: "Cartagena",     px: 24,  py: 19,  dest: true  },
  { name: "Barranquilla",  px: 33,  py: 15,  dest: true  },
  { name: "Santa Marta",   px: 42,  py: 12,  dest: true  },
  { name: "Riohacha",      px: 53,  py: 9,   dest: false },
  { name: "Valledupar",    px: 50,  py: 19,  dest: true  },
  { name: "Mompox",        px: 31,  py: 25,  dest: true  },
  { name: "Montería",      px: 21,  py: 31,  dest: false },
  { name: "Palomino",      px: 45,  py: 13,  dest: false },
  { name: "Cabo de la Vela", px: 60, py: 7,  dest: true  },
  // Insular (San Andrés - in Caribbean sea, shown at top-left)
  { name: "San Andrés",    px: 6,   py: 20,  dest: true  },
  // Pacific coast
  { name: "Quibdó",        px: 10,  py: 49,  dest: true  },
  { name: "Nuquí",         px: 8,   py: 42,  dest: false },
  { name: "Buenaventura",  px: 12,  py: 63,  dest: false },
  // Andes / Centro
  { name: "Medellín",      px: 20,  py: 44,  dest: true  },
  { name: "Guatapé",       px: 23,  py: 41,  dest: true  },
  { name: "Manizales",     px: 19,  py: 48,  dest: true  },
  { name: "Pereira",       px: 18,  py: 51,  dest: true  },
  { name: "Salento",       px: 19,  py: 53,  dest: true  },
  { name: "Bogotá",        px: 40,  py: 54,  dest: true  },
  { name: "Villa de Leyva",px: 42,  py: 43,  dest: true  },
  { name: "Bucaramanga",   px: 47,  py: 35,  dest: true  },
  { name: "Cali",          px: 16,  py: 60,  dest: true  },
  { name: "Popayán",       px: 14,  py: 65,  dest: true  },
  { name: "Tatacoa",       px: 24,  py: 62,  dest: true  },
  { name: "San Agustín",   px: 17,  py: 68,  dest: true  },
  { name: "Pasto",         px: 15,  py: 74,  dest: true  },
  // Orinoquía / Este
  { name: "Arauca",        px: 68,  py: 38,  dest: true  },
  { name: "Villavicencio", px: 44,  py: 58,  dest: false },
  { name: "Caño Cristales",px: 37,  py: 62,  dest: true  },
  // Amazonía / Sur
  { name: "Florencia",     px: 34,  py: 71,  dest: false },
  { name: "Puerto Nariño", px: 48,  py: 87,  dest: true  },
  { name: "Leticia",       px: 52,  py: 91,  dest: true  },
];
